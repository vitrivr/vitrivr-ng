 ...
 */
import { MediaObjectMetadataDescriptor } from './mediaObjectMetadataDescriptor';


export interface MediaObjectMetadataQueryResult { 
    content?: Array<MediaObjectMetadataDescriptor>;
    queryId?: string;
    messageType?: MediaObjectMetadataQueryResult.MessageTypeEnum;
}
export namespace MediaObjectMetadataQueryResult {
