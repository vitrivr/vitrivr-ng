...
import {MediaObjectQueryResult, MediaSegmentQueryResult, Tag} from '../../../../openapi/cineast';

/**
 * This service provides access to the REST API of Cineast
 * @deprecated Replaced by openapi
 */
@Injectable()
export class LookupService extends CineastRestAPI {

  constructor(@Inject(AppConfig) _configService: AppConfig, @Inject(HttpClient) _httpClient: HttpClient) {
