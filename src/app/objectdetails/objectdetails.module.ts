...
@NgModule({
  imports: [MaterialModule, FlexLayoutModule, BrowserModule, AppRoutingModule, M3DLoaderModule, ContainerPipesModule, AdvancedMediaPlayerModule, SegmentfeaturesModule],
