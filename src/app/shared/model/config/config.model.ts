...
export class Config {
    ...
    get vbsEndpoint(): string {
        return this._config.vbs.endpoint;
    }
     ...
     * @deprecated
     */
    get mltCategories(): FeatureCategories[] {
        return <FeatureCategories[]>this._config.mlt;
    }

    /**
     * Accessor for QuerySettings.
     *
     * @return {QuerySettings}
     * @deprecated
     */
    get querySettings(): QuerySettings {
        return <QuerySettings>this._config.query;
    }
}
